      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <div className="relative z-10 text-center space-y-8">
            ...
            >
              <Link to="/contact" className="px-12 py-5 bg-white text-[#2563EB] rounded-full font-black text-lg shadow-2xl hover:shadow-white/30 hover:scale-105 transition-all duration-300 flex items-center space-x-2">
                <FileText className="w-6 h-6" />
                <span>Get Proposal</span>
              </Link>

              <Link to="/contact" className="px-12 py-5 bg-[#FACC15] text-[#0F172A] rounded-full font-black text-lg shadow-2xl hover:shadow-yellow-500/30 hover:scale-105 transition-all duration-300 flex items-center space-x-2">

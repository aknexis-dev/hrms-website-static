      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            {/* Floating Badge — sits over the bottom-left corner of the image */}
            <motion.div
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
              transition={{ delay: 1, type: "spring" }}
              className="absolute bottom-6 left-6 z-20 bg-gradient-to-br from-[#FACC15] to-yellow-500 rounded-2xl p-5 lg:p-6 shadow-2xl"
            >
              <div className="text-[#0F172A] font-black text-2xl lg:text-3xl">5000+</div>

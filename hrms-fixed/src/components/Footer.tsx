        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/" className="text-gray-400 hover:text-[#FACC15] transition-colors">Home</Link>
              </li>
              <li>
                <Link to="/services" className="text-gray-400 hover:text-[#FACC15] transition-colors">Services</Link>
              </li>
              <li>
                <Link to="/industries" className="text-gray-400 hover:text-[#FACC15] transition-colors">Industries</Link>
              </li>
              <li>
                <Link to="/process" className="text-gray-400 hover:text-[#FACC15] transition-colors">Process</Link>
              </li>
              <li>
                <Link to="/about" className="text-gray-400 hover:text-[#FACC15] transition-colors">About Us</Link>
              </li>
              <li>

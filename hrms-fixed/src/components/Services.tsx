  ...
  return (
    <section id="services" className="py-24 bg-gradient-to-br from-[#F8FAFC] to-blue-50/30">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="mt-6 pt-6 border-t border-gray-100">
                <Link to="/services" className="text-[#2563EB] font-semibold flex items-center space-x-2 group-hover:space-x-3 transition-all duration-300">
        ...
        >
          <Link to="/services" className="px-10 py-4 bg-gradient-to-r from-[#2563EB] to-[#1e40af] text-white rounded-full font-semibold shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 inline-flex items-center space-x-2">

          ...
          >
            <div className="grid lg:grid-cols-2 gap-0">
              ...
              <div className="p-10 lg:p-12 flex flex-col justify-center">
                ...
                <Link to="/blog" className="inline-flex items-center space-x-2 text-[#2563EB] font-semibold hover:underline">
      ...
      <section className="py-12 bg-[#F8FAFC]">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Link to="/blog" className="text-[#2563EB] font-semibold hover:underline flex items-center space-x-1">
                      <span>Read</span>
                      <ArrowRight className="w-4 h-4" />
                    </Link>
                  </div>
          ...
          <div className="flex items-center justify-center space-x-2 mt-12">
            <button type="button" className="w-10 h-10 rounded-full bg-white border-2 border-gray-200 flex items-center justify-center hover:border-[#2563EB] transition-colors">
              1
            </button>
            <button type="button" className="w-10 h-10 rounded-full bg-[#2563EB] text-white flex items-center justify-center">
              2
            </button>
            <button className="w-10 h-10 rounded-full bg-white border-2 border-gray-200 flex items-center justify-center hover:border-[#2563EB] transition-colors" type="button">
              3
            </button>
            <button className="w-10 h-10 rounded-full bg-white border-2 border-gray-200 flex items-center justify-center hover:border-[#2563EB] transition-colors" type="button">
              <ArrowRight className="w-4 h-4" />
            ...
            <div className="relative z-10 text-center space-y-8">
              ...
              <div className="max-w-xl mx-auto">
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  />
                  <button type="button" className="px-10 py-4 bg-[#FACC15] text-[#0F172A] rounded-full font-black whitespace-nowrap hover:scale-105 transition-all duration-300">
                    Subscribe Now
                  </button>
                </div>
              </div>
